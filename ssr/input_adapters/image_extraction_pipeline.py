import os
from ssr.utility.os_extension import mkdir_safely, makedirs_safely
...
class ImageExtractionPipeline:
    ...
    def extract_msi(self, pm, oft, execute_parallel, remove_aux_file, apply_tone_mapping, joint_tone_mapping):
        makedirs_safely(pm.msi_workspace_dp)
        create_vissat_extraction_config(
            pm.msi_config_fp,
            pm.msi_ntf_idp,
            pm.msi_workspace_dp,
        ...
        msi_geo_crop_coordinate_list = self.extract_files(
            pm.msi_config_fp,
            ift="MSI",
            oft=oft,
        ...
        return msi_geo_crop_coordinate_list
    ...
    def extract_pan(self, pm, oft, execute_parallel, remove_aux_file, apply_tone_mapping, joint_tone_mapping,
        ...
        makedirs_safely(pm.pan_workspace_dp)
        create_vissat_extraction_config(
